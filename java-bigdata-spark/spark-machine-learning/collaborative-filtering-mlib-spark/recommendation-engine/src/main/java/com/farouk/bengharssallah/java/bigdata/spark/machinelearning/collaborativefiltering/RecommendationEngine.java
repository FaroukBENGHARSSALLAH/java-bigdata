package com.farouk.bengharssallah.java.bigdata.spark.machinelearning.collaborativefiltering;
...
public class RecommendationEngine {
	...
	public static void main(String[] args) {
		...
		JavaPairRDD<Integer,String> itemDescritpion = itemDescritpionFile.mapToPair(new PairFunction<String, Integer, String>() {
							@Override
