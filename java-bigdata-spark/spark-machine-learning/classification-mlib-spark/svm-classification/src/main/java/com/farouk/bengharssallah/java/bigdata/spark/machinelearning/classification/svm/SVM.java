...
public class SVM {
		...
		public static void main(String[] args) {
			...
			Logger.getLogger("akka").setLevel(Level.OFF);
						    ...
						    ImageParser maleImageParser = new ImageParser("180×200", "images/male", "training", "1");
					        maleImageParser.parse();
					        
					        ImageParser femaleImageParser = new ImageParser("180×200", "images/female", "training", "0");
					        femaleImageParser.parse();
						
						 
						             // image trained model data generated by ImagPraser
						JavaRDD training = sc.textFile("training").cache().map(new Function<String,LabeledPoint> () {
								...
								public LabeledPoint call(String v1) throws Exception {
														...
														String featureString[] = v1.substring(v1.lastIndexOf(",") + 1).trim().split(" ");
						...
						JavaRDD test = sc.textFile("sample").cache().map(new Function<String,LabeledPoint> () {
